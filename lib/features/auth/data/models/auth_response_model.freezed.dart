...
class _$AuthResponseModelImpl implements _AuthResponseModel {
  const _$AuthResponseModelImpl({required this.token, this.id});
  ...
  @override
  String toString() {
    return 'AuthResponseModel(token: $token, id: $id)';
  }
...
abstract class _AuthResponseModel implements AuthResponseModel {
  const factory _AuthResponseModel(
      {required final String token, final int? id}) = _$AuthResponseModelImpl;
